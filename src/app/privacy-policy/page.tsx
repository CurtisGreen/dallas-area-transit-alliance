  ...
  return (
    <div className="mb-8">
      ...
      <ul>
        ...
        <li>Organization, affiliation, or employer (if applicable)</li>
        <li>
          IP address (which may include geolocation data such as country, state,
          city, and internet service provider)
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          Cookies and tracking technologies (used for website functionality and
